...
@section('content')
  ...
  <div class="card p-5"><div class="text-sm muted">Restaurantes totales</div><div class="mt-2 text-3xl font-semibold">—</div></div>
  <div class="card p-5"><div class="text-sm muted">Patrocinios activos</div><div class="mt-2 text-3xl font-semibold">—</div></div>
  <div class="card p-5"><div class="text-sm muted">Calificación promedio</div><div class="mt-2 text-3xl font-semibold">—</div></div>
  <div class="card p-5"><div class="text-sm muted">Usuarios registrados</div><div class="mt-2 text-3xl font-semibold">—</div></div>
</div>
